...
window.lampix.registerSimpleClassifier([{
        ...
        width: 304,
        height: 127,
        classifier: "cls_conv_fin" // BOX 1
    }, {
        posX: 98,
        posY: 346,
        width: 304,
        height: 127,
        classifier: "cls_conv_fin" // BOX 2
    }, {
        posX: 98,
        posY: 473,
        width: 304,
        height: 127,
        classifier: "cls_conv_fin" // BOX 3
    }],
    ...
    function(rectIndex, classTag) {
        ...
        // OPTIONS: UPDATE
            ...
            if (rectIndex === 3) { // CALLBACK FOR BOX 1
                data3(); // Visualize Data
                drawIA(); // Draw
            } // END 0

            if (rectIndex === 4) { // CALLBACK FOR BOX 2
                data2(); // Visualize Data
                drawIA(); // Draw
            } // END 1

            if (rectIndex === 5) { // CALLBACK FOR BOX 3
                data1(); // Visualize Data
                drawIA(); // Draw
            } // END 2
